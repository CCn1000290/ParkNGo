                            ...
                            OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(com.example.myapplication.MainActivity.this,
                                                "Authentication success!",  Toast.LENGTH_SHORT).show();
                                        // Intent to move to SigInActivity
                                        ...
                                        Toast.makeText(com.example.myapplication.MainActivity.this, "Authentication failed.",
